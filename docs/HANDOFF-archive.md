# HANDOFF archive (2026-06-14 → 2026-07-30)

Older rolling-handoff entries moved out of HANDOFF.md to cut the auto-loaded context (first pass 2026-07-19, extended 2026-08-04). All work below is committed/shipped unless its own entry says otherwise; the follow-ups that are still live were carried forward to the board at the top of `HANDOFF.md`. Durable facts also live in PROGRESS.md, git history, and Claude's memory.
