...
const PATTERNS = [
  ...
  },
  {
    ...
    build: () =>
      'ماكو توصيل ولا شحن نهائياً — لا لديالى ولا لأي محافظة. الاستلام يكون من محلنا بديالى، '
  ...
  },
  {
    ...
    build: () =>
      'عدنا محل بديالى (بعقوبة)، وتلگاه على خرائط كوكل باسم «مطبعة لولو شوب» — أو من زر الموقع تحت.',
  },
  {
    id: 'howto',
