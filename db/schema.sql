...
-- =====================================================
-- Migration 113: the cost model — repeated here verbatim because deploy.sh applies THIS file.
-- Its seed is guarded by a site_settings marker, NOT by ON CONFLICT; read 113 before touching it.
-- =====================================================
